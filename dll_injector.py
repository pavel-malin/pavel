...
# get a handle to the process we are injecting info.
...
arg_address = kernel32.VirtualAllocx(h_process, 0, dll_len, VIRTUAL_MEM, PAGE_READWRITE)
...
if not kernel32.CreateRemotThread(h_process, None, 0, h_loadlib, arg_address, 0, byref(thread_id)):
